            ...
            <div className="
                ...
                <div className="flex flex-col">
                    ...
                    <div className="grid grid-cols-3 gap-x-7">
                        <img className="w-full h-full cover shadow-lg" src="../../build/cc1.jpg" alt="" />
                        <img className="w-full h-full cover shadow-lg" src="../../build/cc2.jpg" alt="" />
                        <img className="w-full h-full cover shadow-lg" src="../../build/cc3.jpg" alt="" />
                    </div>
