                ...
                <div className="
                    ...
                    grid gap-8">
                        ...
                        <div className="
                            ...
                            md:w-[60%] md:h-[200px]
                            lg:w-[50%] lg:h-full">
                            <img className='w-full h-full cover' src="../../build/bds3.png" alt="" />
                        </div>
                    </div>
                    <div className="
                        sm:w-full sm:h-auto
                        ...
                        <div className="
                            ...
                            md:w-[60%] md:h-[200px]
                            lg:w-[50%] lg:h-full">
                            <img className='w-full h-full cover' src="../../build/ks2.jpg" alt="" />
                        </div>
                    </div>
                    ...
                    <div className="md:h-[200px]
                        ...
                        <div className="
                            ...
                            md:w-[60%] md:h-[200px]
                            lg:w-[50%] lg:h-full">
                            <img className='w-full h-full cover' src="../../build/st2.webp" alt="" />
                        </div>
                    </div>
                    <div className="md:h-[200px]
                        lg:w-full lg:h-auto 
                        ...
                        <div className="
                            ...
                            md:w-[60%] md:h-[200px]
                            lg:w-[50%] lg:h-full">
                            <img className='w-full h-full cover' src="../../build/ns3.jpeg" alt="" />
                        </div>
                    </div>
                </div>
            </div>
